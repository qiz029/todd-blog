---
title: "What Kind of People Make Up a Team?"
description: "From WoW raid guilds to software engineering — idealists, steady operators, and fringe members. And why AI makes lean teams possible again."
pubDate: 2026-05-14
...
First off, not everyone takes the initiative to learn what they need to do. Let's say individual performance is $R_n$, the average performance you need is $P_1$, and the minimum tolerable performance to kill the boss is $P_0$. The raid leader's job is to help everyone get $R_n > P_0$, while ensuring:
