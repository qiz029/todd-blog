...
const schemas = {
	...
	CreatePost: {
		...
		properties: {
			...
			pubDate: { type: 'string', oneOf: [{ format: 'date' }, { format: 'date-time' }], description: 'Use a timestamp with timezone for chronological ordering within a day; date-only values remain supported.' },
			updatedDate: { type: 'string', oneOf: [{ format: 'date' }, { format: 'date-time' }], description: 'Use a timestamp with timezone for chronological ordering within a day; date-only values remain supported.' },
